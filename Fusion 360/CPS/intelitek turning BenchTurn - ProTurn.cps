/**
  ...
  BenchTurn / ProTurn Lathe post processor configuration.

  $Revision: 42585 874da8ae82498831e414340794166d7570bc9e09 $
  $Date: 2019-10-30 15:02:23 $
...
longDescription = "Post for Intelitek BenchTurn / ProTurn turning centers.";
...
properties = {
  machineType: "BenchTurn", // specifies the machine type
...
propertyDefinitions = {
  machineType: {title:"Machine type", description:"Specifies the machine type.", type:"enum", values:[{id:"BenchTurn", title:"BenchTurn"}, {id:"ProTurn", title:"ProTurn"}]},
...
function ToolingData(_tool) {
  ...
  default:
    error(localize("Turret number must be 0! (main turret)"));
    break;
  }
